...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // --- 3. Validate QQ (ERR L04: numbers only) ---
    elseif (!ctype_digit($qq)) {
        $error_msg = "ERR L04: QQ号仅可由数字构成";
    } 
    else {
        ...
        if ($existing) {
            ...
            else $error_msg = "ERR L05: 本QQ号已被用于注册";
        } else {
            ...
            try {
                ...
                $stmt->execute([$uid, $pwdhash, $qq]);
                $success_msg = "注册成功！您的账户目前尚未激活，请联系杰瑞进行激活。";
            } catch (Exception $e) {
